...
export declare class NgbTooltipWindow {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NgbTooltipWindow, "ngb-tooltip-window", never, { "animation": "animation"; "id": "id"; "tooltipClass": "tooltipClass"; }, {}, never, ["*"], false>;
}
/**
...
export declare class NgbTooltip implements OnInit, OnDestroy, OnChanges {
    ...
    constructor(_elementRef: ElementRef<HTMLElement>, rtl: NgbRTL, _renderer: Renderer2, injector: Injector, viewContainerRef: ViewContainerRef, config: NgbTooltipConfig, _ngZone: NgZone, _document: any, _changeDetector: ChangeDetectorRef, applicationRef: ApplicationRef);
    /**
