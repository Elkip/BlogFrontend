...
export declare class NgbPopoverWindow {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NgbPopoverWindow, "ngb-popover-window", never, { "animation": "animation"; "title": "title"; "id": "id"; "popoverClass": "popoverClass"; "context": "context"; }, {}, never, ["*"], false>;
}
/**
...
export declare class NgbPopover implements OnInit, OnDestroy, OnChanges {
    ...
    private _isDisabled;
    constructor(_elementRef: ElementRef<HTMLElement>, rtl: NgbRTL, _renderer: Renderer2, injector: Injector, viewContainerRef: ViewContainerRef, config: NgbPopoverConfig, _ngZone: NgZone, _document: any, _changeDetector: ChangeDetectorRef, applicationRef: ApplicationRef);
    /**
     * Opens the popover.
     *
